...
"""Export ONNX for Stable Diffusion models."""
import os
...
def generate_dummy_inputs(sd_version, device):
    """Generate dummy inputs for SDXL."""
    dummy_input = {}
    if sd_version == "stabilityai/stable-diffusion-xl-base-1.0":
...
def ammo_export_sd(base, exp_name, model_name):
    """Export ONNX for Stable Diffusion XL."""
